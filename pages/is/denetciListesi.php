...
$yni    = Crud::getById(new Program() , 164 ) -> basit();
$mstr   = Crud::getById(new Program() , 161 ) -> basit();
    ...
    <div class="col-lg-12 col-xl-12 pb-3">
        <div class="card shadow">
            <div class="card-header bg-gradient-primary py-3">
            	<h6 class="m-0 font-weight-bold text-gray-300">DENETÇİ LİSTESİ</h6>
            </div>
            <div class="card-body">
                		...
                		<div class="row">
                    		...
                    		<div class="col-2 mb-2">
                              	<a href="<?=PREPATH.$yni['program_link'] ?>" id="dznl_sil" class="btn btn-success col-lg-12" >
                              		<i class="fa fa-plus"></i><span class="text"> Yeni Denetçi Ekle / Düzenle</span>
                          		</a>
                    		</div>
                    		<div  class="col-12">
