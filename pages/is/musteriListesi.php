...
$yni    = Crud::getById(new Program() , 140 ) -> basit();
$mstr   = Crud::getById(new Program() , 149 ) -> basit();
    ...
    <div class="col-lg-12 col-xl-12 pb-3">
        <div class="card shadow">
            <div class="card-header bg-gradient-primary py-3">
            	<h6 class="m-0 font-weight-bold text-gray-300">MÜŞTERİ LİSTESİ</h6>
            </div>
            <div class="card-body">
                		...
                		<div class="row">
                    		...
                    		<div class="col-2 mb-2">
                              	<a href="<?=PREPATH.$yni['program_link'] ?>" id="dznl_sil" class="btn btn-success col-lg-12" >
                              		<i class="fa fa-plus"></i><span class="text">Yeni Müşteri Ekle/Düzenle</span>
                          		</a>
                    		</div>
                    		<div  class="col-12">
                        			...
                        			<tbody>
                            			...
                            			if ($gelen!= null){
                                        	...
                                        	<tr class="listeEleman" onclick="detayAc('<?= $gln->id ?>')">
                                        		...
                                        		<td class="text-left align-middle"><?= $gln->unvan ?> </td>
                                        		<td class="text-center align-middle"><?=(isset($gln->vergi_daire_id->ref->deger) ? $gln->vergi_daire_id->ref->deger->adi : '' ) ?> </td>
