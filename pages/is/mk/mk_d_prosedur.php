...
?>
<div class="card-body" id = "<?='p_'.$prosedurKod.'_'.$p->kod->deger?>">
	<div class="border">
       	<div class="row py-3 ">
        	<div class="col justify-content-center" >
        		<a href="#" onclick="notDuzenle(<?="'".$prosedurKod."','".$p->kod->deger."'" ?>);" id="<?='pNot_'.$prosedurKod.'_'.$p->kod->deger ?>" data-toggle="modal" data-target="#myModalRisk" class="mx-2 btn <?= $ntStr ?> float-right"> 
        			<i id="<?='pZil_'.$prosedurKod.'_'.$p->kod->deger ?>" class="<?= $ntVar ? 'far fa-pulse ' : 'fas' ?> fa-bell " ></i>
        		</a>
            	...
            	<div class="card shadow">
                    <div class="card-body">
                        <div class="row ">
                    		...
                    		<div class="col-lg-8">
                        		<select class=" custom-select form-control" id="<?=$prosedurKod.'_'.$p->id->deger.'_kapsam' ?>">
                    	...
                    	<div class="row">
                    		...
                    		<div class="col-lg-8">
                        		<select class=" custom-select form-control " id="<?=$prosedurKod.'_'.$p->id->deger.'_zaman' ?>">
                        			<option class="dznl_val" value="" selected="selected">Seçiniz</option>
                        			<?php 
                        ...
                        <div class="row">
                        	...
                        	<div class="col-lg-8">
                        		<select class=" custom-select form-control " id="<?=$prosedurKod.'_'.$p->id->deger.'_sonuc' ?>" onchange="prosedurSonuc(<?='\''.$prosedurKod.'\',\''.$p->id->deger.'\'' ?>)" >
                        			<option class="dznl_val" value="" selected="selected">Seçiniz</option>
                        			<?php 
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div class="row" 	id="riskList_<?=$prosedurKod?>_<?=$p->kod->deger ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="card shadow h-100">
                            ...
                            <div class="card-body">
                                <div class="row" id="refsList_<?=$prosedurKod?>_<?=$p->kod->deger ?>">
                                </div>
                            </div>
                        </div>
                    </div>
            	...
            	<div class="card shadow h-100">
            		<div class="card-body">
            			<div class="row mb-2">
                            ...
                            <div class="col-7">									<textarea rows="2" class="form-control" id="<?=$prosedurKod.'_'.$p->id->deger.'_aciklama' ?>" ><?= $p->aciklama->deger ?></textarea></div>
                        	<div class="col-1 text-center align-self-center">	
                        		<a href="<?=PREPATH.'pages/is/prosedurDosya.php?tklf_id='.$tklf_id.'&grup='.$prosedurKod.'&kod='.$p->kod->deger.'&drive_id='.$p->drive_id->deger.'&p_id='.$pId ?>"class="my-0 btn btn-primary" id="refsList_<?=$prosedurKod.'_'.$p->kod->deger ?>_da"  title="asd" ><i class="fas fa-folder-open fa-2x"></i></a>
                    		</div>
                    	</div>
            		</div>
            	</div>
