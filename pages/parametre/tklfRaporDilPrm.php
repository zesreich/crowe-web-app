            		...
            		<table id="tablebot" class="table table-bordered table-striped" >
            			<thead>
            				<tr>
            					...
            					<th class="bg-gray-700 text-gray-200 text-center align-middle">kisaltma  </th>
            				</tr>
            			</thead>
            			<tbody>
                			<?php 
                			if ($gelen != null){
                            	...
                            	<tr class="listeEleman" onclick="detayAc('<?= $gln->id ?>')" >
                            		...
                            		<td class="text-center align-middle"><?= $gln->kisaltma ?> </td>
                            	</tr>
                                <?php 			    
                    			}
                			}
        ...
        <div class="card shadow" >
            ...
            <div class="card-body">
                <form class="user">
                    ...
                    <div class="row mb-2">
                		<div class="col-lg-4 font-weight-bold text-gray-800 align-self-center  text-right">Kısaltma :</div>
                		<div class="col-lg-8"><input type="text" class="form-control form-control-user" id="dznl_kisaltma" ></div>
                	</div>
                    <div class="row mb-2">
	...
	function detayAc(id){
	    ...
	    $.get( "<?php echo PREPATH.'post/genelPost.php?tur=getById&tablo='.get_class($tbl).'&id='?>"+id, function(data, status){
			if(status == "success"){
			    ...
			    $('#dznl_id').				val(obj.id);
			    $('#dznl_ad').				val(obj.adi);
			    $('#dznl_kisaltma').		val(obj.kisaltma);
...
// 		        		console.log(data);
    ...
    function fromValid( sfr = false){
	    ...
	    var snc2 = !sfr && ($('#dznl_kisaltma').val() == null || $('#dznl_kisaltma').val() == "");
	    
		fromAlanValid('#dznl_ad',snc1) ;
		fromAlanValid('#dznl_kisaltma',snc2) ;
