            		...
            		<table id="tablebot" class="table table-bordered table-striped" >
            			<thead>
            				<tr>
            					...
            					<th class="bg-gray-700 text-gray-200 text-center align-middle">Sembol  </th>
            				</tr>
            			</thead>
            			<tbody>
                			<?php 
                			if ($gelen != null){
                            	...
                            	<tr class="listeEleman" onclick="detayAc('<?= $gln->id ?>')" >
                            		...
                            		<td class="text-center align-middle"><?= $gln->sembol ?> </td>
                            	</tr>
                                <?php 			    
                    			}
                			}
            ...
            <div class="card-body">
                <form class="user">
                    ...
                    <div class="row mb-2">
                		...
                		<div class="col-lg-8"><input type="text" class="form-control form-control-user" id="dznl_sembol" ></div>
                	</div>
                    <div class="row mb-2">
...
// 		        		console.log(data);
    ...
    function fromValid( sfr = false){
	    ...
	    var snc2 = !sfr && ($('#dznl_sembol').val() == null || $('#dznl_sembol').val() == "");
	    
		fromAlanValid('#dznl_ad',snc1) ;
		fromAlanValid('#dznl_sembol',snc2) ;
