            		...
            		<table id="tablebot" class="table table-bordered table-striped" >
            			<thead>
            				<tr>
            					...
            					<th class="bg-gray-700 text-gray-200 text-center align-middle">Kod  </th>
            			...
            			<tbody>
                			...
                			if ($gelen != null){
                            	...
                            	<tr class="listeEleman" onclick="detayAc('<?= $gln->id ?>')" >
                            		...
                            		<td class="text-center align-middle"><?= $gln->kod ?> </td>
            ...
            <div class="card-body">
                <form class="user">
                    ...
                    <div class="row mb-2">
                		...
                		<div class="col-lg-8"><input type="text" class="form-control form-control-user" id="dznl_kod" ></div>
                	</div>
                    <div class="row mb-2">
