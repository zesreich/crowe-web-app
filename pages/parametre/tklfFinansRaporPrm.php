            		...
            		<table id="tablebot" class="table table-bordered table-striped" >
            			<thead>
            				<tr>
            					...
            					<th class="bg-gray-700 text-gray-200 text-center align-middle">Açıklama  </th>
            				</tr>
            			</thead>
            			<tbody>
                			<?php 
                			if ($gelen != null){
                            	...
                            	<tr class="listeEleman" onclick="detayAc('<?= $gln->id ?>')" >
                            		...
                            		<td class="text-center align-middle"><?= $gln->aciklama ?> </td>
                            	</tr>
                                <?php 			    
                    			}
                			}
...
// 		        		console.log(data);
    ...
    function fromValid( sfr = false){
	    ...
	    var snc2 = !sfr && ($('#dznl_aciklama').val() == null || $('#dznl_aciklama').val() == "");
	    
		fromAlanValid('#dznl_ad',snc1) ;
		fromAlanValid('#dznl_aciklama',snc2) ;
