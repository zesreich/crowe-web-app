            		...
            		<table id="tablebot" class="table table-bordered table-striped" >
            			...
            			<tbody>
                			...
                			if ($gelen != null){
                                ...
                                ?>
                            	<tr class="listeEleman" onclick="detayAc('<?= $gln->id ?>')" style="background-color:<?= $gln->color ?>">
        ...
        <div class="card shadow" >
            ...
            <div class="card-body">
                <form class="user">
                    ...
                    <div class="row mb-2">
                		<div class="col-lg-4 font-weight-bold text-gray-800 align-self-center  text-right">Renk :</div>
                		<div class="col-lg-8"><input type="color" id="dznl_renk" ></div>
                	</div>
                    <div class="row mb-2">
...
// 		        		console.log(data);
    ...
    function fromValid( sfr = false){
	    ...
	    var snc2 = !sfr && ($('#dznl_renk').val() == null || $('#dznl_renk').val() == "");
	    
		fromAlanValid('#dznl_ad',snc1) ;
		fromAlanValid('#dznl_renk',snc2) ;
