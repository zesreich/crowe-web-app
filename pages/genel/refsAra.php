...
$list = Crud::getSqlCokTblsiz(new Referanslar(), Referanslar::ALL, array());
?>
<style>
th.rotate {
  height:140px;
	...
	<table id="araTablebot" class="table table-bordered" >
		<thead>
			<tr>
				...
				<th style="width: 10%" class="bg-gray-700 text-gray-200 text-center align-middle">KOD&nbsp;<i id="i1" class="srt fas fa-sort" aria-hidden="true"></i></th>
				<th style="width: 44%" class="bg-gray-700 text-gray-200 text-center align-middle">ADI&nbsp;<i id="i1" class="srt fas fa-sort" aria-hidden="true"></i></th>
			...
			<?php 
    			if ($list!= null){
    			    foreach ($list as $gln){
			            ...
			            echo '<td class="text-center align-middle"><button type="button" class="btn btn-outline-primary" data-dismiss="modal" onclick="refsAppend('.$gln['id'].','.$_GET['pId'].',\''.$_GET['grup'].'\',\''.$_GET['kod'].'\')">SEÇ</button></td>';
    			        echo '</tr>';
    			    }
    			}
            ?>
