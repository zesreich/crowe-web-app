...
$list = Crud::getSqlCokTblsiz(new RiskProsedur(), RiskProsedur::ARA_RISK_ID, array('risk'=>$_GET['risk']));
?>
<style>
th.rotate {
  height:140px;
			...
			<?php 
    			if ($list!= null){
    			    foreach ($list as $gln){
			            ...
			            echo '<td class="text-center align-middle"><button type="button" class="btn btn-outline-primary" data-dismiss="modal" onclick="riskProEkle('.$gln['id'].')">SEÇ</button></td>';
    			        echo '</tr>';
    			    }
    			}
            ?>
