...
-- Complete SQL Script with Real Password Hashes
-- =====================================================
...
-- Insert Admin Users
-- =====================================================
-- Note: These password hashes are placeholders
-- Run generate-password-hashes.js to generate real bcrypt hashes
...
BEGIN
    ...
    -- For now, return user info (password verification should be done in application layer)
    RETURN QUERY
    SELECT 
        v_user.id,
        v_user.username,
        ...
        v_user.email,
        v_user.role
    WHERE v_user.password_hash = crypt(p_password, v_user.password_hash);
END;
